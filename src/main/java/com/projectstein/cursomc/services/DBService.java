...
import com.projectstein.cursomc.domain.enums.Perfil;
...
public class DBService {
	...
	public void instatiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "suportearrecadacao@projetatecnologia.com.br", "36378912377", TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "projectstein@gmail.com", "82728337004", TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27353323","93839393"));
		
		
		
		Endereco e1= new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834",cli1,c1);
		Endereco e2= new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38220834",cli1,c2);
		Endereco e3= new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "29220834",cli2,c2);
